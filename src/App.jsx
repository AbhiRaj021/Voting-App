...
import { getCricketVotes, getFootballVotes } from './firebase';
...
function App() {
  ...
  useEffect(() => {
    getCricketVotes()
      .then((data) => setCricketVotes(data))
      .catch((error) => console.error("Error setting cricket votes:", error));
  
    getFootballVotes()
      .then((data) => setFootballVotes(data))
      .catch((error) => console.error("Error setting football votes:", error));
  }, []);
              ...
              <div className="footballVotes">
                ...
                <h1>
                  <label htmlFor="progressFootballVotes">
                    {percentOfFootballVotes &&
                      Math.round(percentOfFootballVotes)}
                    %
                  </label>
                  <progress
